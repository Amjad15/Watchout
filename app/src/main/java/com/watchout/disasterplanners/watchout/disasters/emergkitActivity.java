...
import com.watchout.disasterplanners.watchout.bag.ListViewItemCheckboxBaseAdapter;
import com.watchout.disasterplanners.watchout.bag.ListViewItemDTO;

import java.util.ArrayList;
import java.util.List;

public class emergkitActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_emergkit);
    ...
    {
        String itemTextArr[] = {"canned foods", "swiss army knife", "water", "flashlight", "batteries", "sanitary item", "cash", "medicine","wrench" ,"fire extinguisher","copy of important doc.", "balnket"};
